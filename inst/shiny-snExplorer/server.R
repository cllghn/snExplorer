shinyServer(function(input, output, session) {
  ...
  observeEvent(input$node_sizing, {
    get_sizes <- reactive({
      ...
      if ("total_degree" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
            name = "total_degree"
      ...
      if ("in_degree" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
            name = "in_degree"
      ...
      if ("out_degree" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
            name = "out_degree"
      ...
      if ("betweenness" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
            name = "betweenness"
      ...
      if ("eigenvector" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
            name = "eigenvector"
      ...
      if ("rconstraint_ego" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
      ...
      if ("rconstraint_extended" %in% input$node_sizing) {
        return(
          vertex_attr(
            get_graph(),
