...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/cjcallag/snExplorer?branch=master&svg=true)](https://ci.appveyor.com/project/cjcallag/snExplorer)
